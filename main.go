...
func main() {
	...
	check_args(args)
	process_input(args)
	fmt.Println("start:", args.startPage)
	fmt.Println("end:", args.endPage)
	fmt.Println("infile:", args.inFile)
	fmt.Println("pagelen:", args.pageLen)
	fmt.Println("pagetype:", args.pageType)
	fmt.Println("destination:", args.printDestination)
}
